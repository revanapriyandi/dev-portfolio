...
const ContactForm: React.FC = () => {
  const [error, setError] = useState<Error>({ email: false, required: false });
      ...
      <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <button
              className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-[#16f2b3] to-violet-600 px-5 md:px-12 py-2.5 md:py-3 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold"
              role="button"
